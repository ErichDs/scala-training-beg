...
object TuplesAndMaps extends App {
  ...
  /*
    1.  What would happen if I had two original entries "Jim"-> and "JIM"-> 900?
        A: !!! careful with mapping keys, or you may lost some data
  ...
  def nPeopleWithNoFriends(network: Map[String, Set[String]]): Int =
    network.count(_._2.isEmpty) // equivalent: network.count(pair => pair._2.isEmpty)

  val testNet2 = add(testNet, "Erich")
  println(nPeopleWithNoFriends(testNet2))
